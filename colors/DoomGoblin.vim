"  ____                         ____       _     _ _       
" |  _ \  ___   ___  _ __ ___  / ___| ___ | |__ | (_)_ __  
" | | | |/ _ \ / _ \| '_ ` _ \| |  _ / _ \| '_ \| | | '_ \ 
" | |_| | (_) | (_) | | | | | | |_| | (_) | |_) | | | | | |
" |____/ \___/ \___/|_| |_| |_|\____|\___/|_.__/|_|_|_| |_|
"
"
" A Vim colorscheme based on badwolf by Steve Losh.
...
let g:colors_name = "DoomGoblin"

if !exists("g:DoomGoblin_html_link_underline") " {{{
    let g:DoomGoblin_html_link_underline = 1
endif " }}}

if !exists("g:DoomGoblin_css_props_highlight") " {{{
    let g:DoomGoblin_css_props_highlight = 0
endif " }}}
...
let s:bwc.blackgravel    = ['242321', 233]
let s:bwc.blackestgravel = ['141413', 232]
let s:bwc.blackUnicorn 	 = ['000000', 16]
...
" A less limier green.
let s:bwc.slimeGreen = ['6EFF77', 10]
...
if exists('g:DoomGoblin_darkgutter') && g:DoomGoblin_darkgutter
    let s:gutter = 'blackestgravel'
else
    let s:gutter = 'blackUnicorn'
endif

if exists('g:DoomGoblin_tabline')
    if g:DoomGoblin_tabline == 0
        let s:tabline = 'blackestgravel'
    elseif  g:DoomGoblin_tabline == 1
        let s:tabline = 'blackgravel'
    elseif  g:DoomGoblin_tabline == 2
        let s:tabline = 'darkgravel'
    elseif  g:DoomGoblin_tabline == 3
...
call s:HL('Normal', 'plain', 'blackUnicorn')
...
" Preprocessor stuff is slimeGreen, to make it pop.
"
" This includes imports in any given language, because they should usually be
" grouped together at the beginning of a file.  If they're in the middle of some
" other code they should stand out, because something tricky is
" probably going on.
call s:HL('PreProc',   'slimeGreen', '', 'none')
call s:HL('Macro',     'slimeGreen', '', 'none')
call s:HL('Define',    'slimeGreen', '', 'none')
call s:HL('PreCondit', 'slimeGreen', '', 'bold')
...
call s:HL('Type', 'slimeGreen', '', 'none')
...
call s:HL('InterestingWord2', 'coal', 'slimeGreen')
...
call s:HL('lispFunc',           'slimeGreen', '', 'none')
...
if g:DoomGoblin_css_props_highlight
...
call s:HL('diffAdded', 'slimeGreen', '',)
...
call s:HL('htmlSpecialChar',    'slimeGreen',   '', 'none')
...
if g:DoomGoblin_html_link_underline
...
call s:HL('texRefZone', 'slimeGreen', '', 'none')
call s:HL('texComment', 'darkroast', '', 'none')
call s:HL('texDelimiter', 'orange', '', 'none')
call s:HL('texZone', 'brightgravel', '', 'none')

augroup DoomGoblin_tex
    au!
...
call s:HL('lessVariable', 'slimeGreen', '', 'none')

" }}}
" Lispyscript {{{

call s:HL('lispyscriptDefMacro', 'slimeGreen', '', '')
...
call s:HL('mailQuoted5', 'slimeGreen', '', 'none')
...
call s:HL('markdownH2', 'slimeGreen', '', 'bold')
call s:HL('markdownH3', 'slimeGreen', '', 'none')
call s:HL('markdownH4', 'slimeGreen', '', 'none')
call s:HL('markdownH5', 'slimeGreen', '', 'none')
call s:HL('markdownH6', 'slimeGreen', '', 'none')
...
call s:HL('pythonException',   'slimeGreen', '', 'bold')
call s:HL('pythonExceptions',  'slimeGreen', '', 'none')
call s:HL('pythonPrecondit',   'slimeGreen', '', 'none')
